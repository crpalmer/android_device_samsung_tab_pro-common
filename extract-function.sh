...
BASE_PROP=../../samsung/tabpro-common/proprietary-files.txt
BASE=vendor/samsung/tabpro-common
...
./../../samsung/tabpro-common/setup-makefiles.sh $BASE_PROP ../../../$BASE $BASE_DIR tabpro-common
./../../samsung/tabpro-common/setup-makefiles.sh $DEV_PROP ../../../$DEV_BASE $DEV_DIR $DEVICE
